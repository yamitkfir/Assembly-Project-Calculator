...
; --------------------------
	...
	WrongAction db 'Dont you dare trying a different char from for your action /, +, -, * ;) $'
	TooBig db ' sorry m8, im not capble of handling this large number. try again...', 13, 10, '$'
...
Yalla:
	cmp cx, 0
	je toobigm8
	cmp [Wtemp], 7FFFh ; 7FFF is the biggest number a positive word can have
	;ja toobigm8
